...
public class JavaLang02 {
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		if(soccer1.equals(soccer2)) {	// 같다 
			System.out.println("soccer1과 soccer2 같다.");
		} else {
			System.out.println("soccer1과 soccer2 다르다.");

		}
		if(soccer1.equals(soccer3)) {	// 다르다
			System.out.println("soccer1과 soccer3 같다.");
		} else {
			System.out.println("soccer1과 soccer3 다르다.");
